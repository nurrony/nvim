...
return {
  ...
  config = function(_, opts)
    ...
    --   ["]"]             = { name = "󰒭 next" },
    --   ["["]             = { name = "󰒮 prev" },
    --   ["<leader><tab>"] = { name = "󰓫 tabs" },
    --   ["<leader>c"]     = { name = "󰈮 code" },
    --   ["z"]             = { name = " folds" },
    --   ["<leader>sn"]    = { name = "󰛰 noice" },
    --   ["<leader>s"]     = { name = "󰺮 search" },
    --   ["<leader>w"]     = { name = "󰖲 windows" },
    --   ["gz"]            = { name = "󱃗 surround" },
    --   ["<leader>d"]     = { name = " debugger" },
    --   ["<leader>f"]     = { name = "󰈞 file/find" },
    --   ["<leader>u"]     = { name = "󰔡 ui/toggle" },
    --   ["<leader>gh"]    = { name = " gitsigns/hop" },
    --   ["<leader>q"]     = { name = "󰿅 quit/session" },
    --   ["<leader>b"]     = { name = " buffer/BufferLine" },
    --   ["<leader>x"]     = { name = "d diagnostics/quickfix" },
    -- }
    --
    local keymaps = {
      {
        mode = { "n", "v" },
        { "<leader><tab>", group = "󰓫 tabs" },
        { "<leader>b", group = " buffer/BufferLine" },
        { "<leader>c", group = "󰈮 code" },
        { "<leader>d", group = " debugger" },
        { "<leader>f", group = "󰈞 file/find" },
        { "<leader>g", group = "󰊢 git" },
        { "<leader>gh", group = " gitsigns/hop" },
        { "<leader>q", group = "󰿅 quit/session" },
        { "<leader>s", group = "󰺮 search" },
        { "<leader>sn", group = "󰛰 noice" },
        { "<leader>u", group = "󰔡 ui/toggle" },
        { "<leader>w", group = "󰖲 windows" },
        { "<leader>x", group = "d diagnostics/quickfix" },
        { "[", group = "󰒮 prev" },
        { "]", group = "󰒭 next" },
        { "g", group = "󱋿 goto" },
        { "gz", group = "󱃗 surround" },
